...
export function OverviewTab({ 
  ...
  }, [instanceId, instance.status, instance.access?.url]);
  ...
  return (
    <div className="space-y-6">
        ...
        <Card className="border-purple-200 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-950/20 dark:to-pink-950/20">
          <CardContent className="flex items-center justify-between py-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg mb-1">{t('aiCta')}</h3>
      ...
      <Card>
        <CardHeader>
          <CardTitle>{t('accessInfo')}</CardTitle>
          <CardDescription>{t('accessInfoDescription')}</CardDescription>
        </CardHeader>
          ...
          {instance.access?.url && (
            <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-900 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium">{t('instanceUrl')}</p>
                  <a 
      ...
      {instance.awsResources && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>{t('infrastructureDescription')}</CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            ...
            {instance.awsResources.ecsService && (
              <div className="flex items-center justify-between text-sm">
                <span className="text-gray-600">{t('ecsService')}</span>
            ...
            {instance.awsResources.vpcId && (
              <div className="flex items-center justify-between text-sm">
                <span className="text-gray-600">{t('vpcId')}</span>
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-2 gap-4">
          ...
          <div>
            <p className="text-sm text-gray-600 mb-1">{t('size')}</p>
          ...
          <div>
            <p className="text-sm text-gray-600 mb-1">{t('monthlyCost')}</p>
            <p className="font-medium">${instance.billing?.monthlyCharge || 0}{t('perMonth')}</p>
          </div>
        </CardContent>
      </Card>
    </div>
